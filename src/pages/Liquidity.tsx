...
function Liquidity() {
  ...
  const connectWallet_ = async () => {
    try {
      ...
      if (isPair) {
        console.log("---------- pair", aaveVault, pairAddress);
      ...
      const ownerAddress = await aaveVault.methods.owner().call();
      console.log("owner address --------", ownerAddress, '||', account);
  ...
  }, [account, chainId, isConnected, balanceLP, isPair, pairAddress, reserveUSDT, xfiAddress]);
  ...
  const handleXXXOfVaultChange = async (e: any) => {
    ...
    console.log('handleXXXOfVaultChange', e.target.value, e.target.value.length);
  ...
  const handleAddXXX = async (
    ...
    if( parseFloat(xxxAmountOfVault) > parseFloat(xfiBalance) ) {
  ...
  const handleRemoveXXX = async (
    ...
    if( parseFloat(xxxAmountOfVault) > parseFloat(xfiVaultBalance) ) {
      toast.info("Current balance is not enough!");
      setIsDisable(false);
      return;
    }
              ...
              (<div>
                  ...
                  <div className="flex justify-center">
                    ...
                    (
                      <button
                        type="button"
                        className="place-content-center mx-5 w-full mt-10 py-2 px-10 text-xl font-bold text-white bg-primary rounded-full bg-opacity-85 hover:bg-opacity-90 disabled:bg-indigo-400"
            ...
            :
              (<div>
                ...
                <div className="flex justify-center">
                  {isProgressing3 ?
                  (
                    <div className='place-content-center mx-5 w-full px-10 font-bold text-white bg-primary rounded-full'>
                  ...
                  (
                    <button
                      ...
                      disabled={xxxAmountOfVault === "0" || xxxAmountOfVault.length === 0 || isDisable}
                      onClick={handleAddXXX}
                    >
                      {(xxxAmountOfVault === "0"|| xxxAmountOfVault.length === 0)
                        ? "Enter an amount"
                        : "Add XFI"}
                    </button>
                  )}
                ...
                <div className="flex justify-center">
                  {isProgressing4?
                  (
                    <div className='place-content-center mx-5 w-full mt-7 px-10 font-bold text-white bg-primary rounded-full'>
                  ...
                  (
                    <button
                      type="button"
                      className="place-content-center mx-5 w-full mt-7 py-2 px-10 text-lg font-bold text-white bg-primary rounded-full bg-opacity-85 hover:bg-opacity-90 disabled:bg-indigo-400"
                      disabled={xxxAmountOfVault === "0" || xxxAmountOfVault.length === 0 || isDisable}
